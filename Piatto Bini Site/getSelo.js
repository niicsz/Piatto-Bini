...
! function (e) {
    ...
    null !== g && (g.value = function (e, t) {
        ...
        if (null != d) {
            ...
            d.innerHTML = "";
            let n = new Image;
            return n.src = "https://newimgebit-a.akamaihd.net/ebitBR/selo/img_" + o + ".png", n.style.border = "0px", d.style.display = "block", d.style.overflow = "hidden", d.style.position = "relative", d.setAttribute("onContextmenu", 'alert("Cópia proibida! A certificação Ebit é de uso exclusivo das lojas conveniadas Ebit.");return false;'), -1 === d.href.indexOf("/selo") && (function (e) {
